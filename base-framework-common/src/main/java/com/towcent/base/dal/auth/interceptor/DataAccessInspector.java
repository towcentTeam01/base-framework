...
public class DataAccessInspector implements Interceptor {
	...
	private MetaObject getMappedStatement(Invocation invocation) {
		...
		MetaObject metaStatementHandler = null; // TODO (MetaObject) MetaObject.forObject(statementHandler, DEFAULT_OBJECT_FACTORY, DEFAULT_OBJECT_WRAPPER_FACTORY);
		...
		while (metaStatementHandler.hasGetter("h")
			...
			if (object != null) {
				// TODO metaStatementHandler = (MetaObject) MetaObject.forObject(object, DEFAULT_OBJECT_FACTORY, DEFAULT_OBJECT_WRAPPER_FACTORY);
			}
		}
